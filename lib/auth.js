...
const DEFAULT_SECRET = 'wx-support-fallback-secret-change-in-production-9f3k2p'
...
export function verifyToken(token) {
  try { return jwt.verify(token, process.env.JWT_SECRET || DEFAULT_SECRET) } catch { return null }
}
